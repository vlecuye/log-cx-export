...
gcloud logging read 'logName="projects/'${PROJECT_ID}'/logs/dialogflow-runtime.googleapis.com%2Frequests" AND timestamp>="'${1}'T00:00:00Z" AND timestamp<="'${1}'T23:59:59Z"' --format=json | gcloud storage cp - $obj/export-$1.json
